<?php
session_start();
require_once 'app/functions/function2.php';
require_once 'app/functions/config2.php';

if (!isset($_SESSION['user'])) {
  header('Location: app/auth/login2.php');
  exit;
}

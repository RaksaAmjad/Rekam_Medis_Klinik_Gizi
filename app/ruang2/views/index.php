    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="?page=tambah-ruang2" class="btn btn-primary round waves-effect waves-light">
            Tambah Kunjungan
          </a>
        </div>
                ...
                <tbody>
                  <?php foreach ($ruangs as $ruang) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="?page=edit-ruang2&id=<?= $ruang['id']; ?>"><i class="m-1 feather icon-edit-2"></i></a>
                        <a href="?page=hapus-ruang2&id=<?= $ruang['id']; ?>" class="btn-hapus"><i class="feather icon-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
